...
# 链接 JavaScriptCore.framework（AdMob SDK 依赖）
find_library(JAVASCRIPT_CORE_FRAMEWORK JavaScriptCore)
if(JAVASCRIPT_CORE_FRAMEWORK)
    target_link_libraries(${EXECUTABLE_NAME} ${JAVASCRIPT_CORE_FRAMEWORK})
endif()
